...
let MovieResolver = class MovieResolver {
    movies(ctx) {
        return ctx.em.find(Movie_1.Movie, {}, ['users']);
    }
    movie(id, ctx) {
        return ctx.em.findOne(Movie_1.Movie, { id }, ['users']);
    }
    topNominations(ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            const movies = yield ctx.em.find(Movie_1.Movie, {}, ['users']);
            return movies.sort((a, b) => b.users.length - a.users.length).filter(movie => movie.users.length > 0).slice(0, 5);
        });
    }
    createMovie(imdbId, title, year, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            const movie = ctx.em.create(Movie_1.Movie, { imdbId, title, year });
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], MovieResolver.prototype, "topNominations", null);
__decorate([
    type_graphql_1.Mutation(() => Movie_1.Movie),
    __param(0, type_graphql_1.Arg("imdbId", () => String)),
    __param(1, type_graphql_1.Arg("title", () => String)),
    __param(2, type_graphql_1.Arg("year", () => type_graphql_1.Int)),
